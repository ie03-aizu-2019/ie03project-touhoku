    ...
    public static void main(String[] args) {
        ...
        for (int n = 0; n < crossPoints.size(); n++) {
            ...
            if (crossPoints.get(n).Judje_cross() == 1) {
                ...
                } else if (crossPoints.get(n).CrossingVec.Eq(crossPoints.get(n).line1.P2,
                        crossPoints.get(n).CrossingVec)) {
                ...
                } else if (crossPoints.get(n).CrossingVec.Eq(crossPoints.get(n).line2.P1,
                        crossPoints.get(n).CrossingVec)) {
                ...
                if (Main.line_graph[i][j] == 1) {
                    for (int k = j + 1; k < points.size(); k++) {
                        if (Main.line_graph[i][k] == 1 && Main.line_graph[j][k] == 1 && Main.line_graph[k][j] == 1) {
                            if (line_a(points.get(i), points.get(j), points.get(k)) == true
                                    && line_b(points.get(i), points.get(j), points.get(k)) == true) {
